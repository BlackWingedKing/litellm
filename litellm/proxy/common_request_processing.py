...
class ProxyBaseLLMRequestProcessing:
    ...
    def get_custom_headers(
        ...
        **kwargs,
        ...
        forwarded_headers: Final = {  # mutable-ok: downstream response hooks require a header dict
        ...
        headers: Final = {
            ...
            **{k: str(v) for k, v in forwarded_headers.items()},  # mutable-ok: normalize header values once
            "x-litellm-core": core_engine,
            # mutable-ok: legacy header is conditional on the final engine
