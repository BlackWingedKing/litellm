...
rust_ocr_enabled: Final = configuration.rust_ocr_enabled
use_litellm_rust: Final = configuration.use_litellm_rust


def _env_enables_rust_ocr() -> bool:  # pyright: ignore[reportUnusedFunction]  # legacy compatibility probe
    return configuration.env_enables_rust_ocr()
